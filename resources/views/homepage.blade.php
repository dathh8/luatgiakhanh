...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Gia Khánh</a></h1>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Doanh nghiệp đấu giá tư nhân Gia Khánh</h1><br>
      <h2>Nghĩ cái gì mà viết vào</h2>
      <a href="#about" class="btn-get-started scrollto">Kiếm cái ảnh các thứ</a>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <h3 data-aos="fade-up">Nội dung.....</h3>
            <p data-aos="fade-up">
              Xem xem cái template này ổn k k thì tìm cái khác. Xem nội dung cho web đi là đc.
            </p>
            <div class="icon-box" data-aos="fade-up">
              <i class="bx bx-receipt"></i>
              <h4>Cứ xem đi, web tĩnh k có chức năng gì đâu</h4>
